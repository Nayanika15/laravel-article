      ...
      <div class="container">        
        <div class="row blog-entries element-animate">
          ...
          <div class="col-md-12 col-lg-8 main-content">
            <img src="{{ ($article->getMedia('articles')->count() > 0)?$article->getFirstMedia('articles')->getUrl('detail'): '' }}" alt="Image" class="img-fluid mb-5">
             <div class="post-meta">
                        <span class="author mr-2"><img src="{{asset('images/person_1.jpg')}}" alt="Colorlib" class="mr-2">{{ ($article->user()->first()->name) ?? $article->user()->first()->name ?? 'guest' }} </span>&bullet;
